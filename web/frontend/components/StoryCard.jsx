...
// export function StoryCard({ sendDataViewToIndex }) {
//     const fetch = useAuthenticatedFetch();
//     const handleClick = (codebar_a_transmetre) => {
//         const dataView = "Données à transmettre";
//         sendDataViewToIndex(codebar_a_transmetre);
//     };
...
//             >
//                 <IndexTable.Cell>
//                     <Link url="kdkkd" onClick={() => console.log("Clicked ")}>
...
//                 <IndexTable.Cell>{Douanes}</IndexTable.Cell>
//                 <IndexTable.Cell>
//                     <Button onClick={() => handleClick(CodeBarre)}>
//                         {" "}
//                         voir
//                     </Button>
//                 </IndexTable.Cell>
